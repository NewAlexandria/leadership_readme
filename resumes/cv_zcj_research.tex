...
\color{BrickRed}{ R\&D / IP Resume Only.  For CV, see the links below.  }
...
AR, HCI, Simulation, 3D/CNC, hydrodynamics.
...
\includegraphics[width=2.3in]{github-work2}
...
\begin{tightitemize}
\item Research \& modeling of semantic features in job messaging \& time-series.
...
Platform and Component strategy for Clinical Trials design and analysis.
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
\item Developed a data-product strategy for partner apps in our cloud.
\item Designed lambda-as-a-service architecture 3yr before FOSS \& AWS options.
\item Designed and executed 14-layer QA automation. Niche tools and strategies.
\item Highly configurable grid rendering system for Study Design.
\item Set process standards, 150-200\% productivity gains. Team of 200.
...
2019 & \textbf{M\&A exit:} Personalization.\\
 & Exit price 11x from when hired\\
...
\runsubsection{Weather-sensitive Crystal Reactor}
\descript{| ASU, New Alexandria}
