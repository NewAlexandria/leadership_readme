...
\runsubsection{Even Financial}
\descript{| VP Engineering}
\location{Aug 2018 - Present | New York, NY}

\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
\item Personalization systems in Scala and React. Refine CDP design.
\item Build and automation of cloud security compliance, governance, diligence.
\item Admin applications with permissions entitlement.
\end{tightitemize}
